...
def parse_args():
    ...
    parser.add_argument('--data_path', default='dataset/SFHDataset/SFH/SFH_Dataset_S2CITIES_raw_ratio1_112x112_fps6.4', type=str, help='Path for train/test/val video files.')
